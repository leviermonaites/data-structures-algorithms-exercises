/*
    ...
    Ultimately, I found out that my way is better, but it could improve, and it's seen in the Fibonacci file localized in the FibonacciMemoize folder.
*/

const fibonacci = (times, value = 0, oldValue = 0) => {
  if (times >= 1) {
    const newValue = value < 1 ? value + 1 : value + oldValue;
    const newOldValue = value;
